# Codex bootstrap for mtg-sim

Read this file first. It tells Codex what this repo is, how to navigate it, and which conventions apply.
...
See `CONVENTIONS.md` and the upstream at https://github.com/Zuxas/Codex-harness/blob/main/CONVENTIONS.md. Specifically:
