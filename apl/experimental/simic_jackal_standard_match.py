# Auto-generated match APL for Simic Jackal (standard)
# Generated: 2026-04-19 by gemma_apl_chunked.py
# Role: midrange | Max turns: 10 | Blocking: favorable
#
# Gemma analyzed 4 cards, produced 1 priority rules
...
class SimicJackalStandardMatchAPL(MatchAPL):
    ...
    def main_phase_match(self, gs, opponent):
        ...
        for c in list(gs.zones.hand):
            if c.name == "Floodpits Drowner" and gs.mana_pool.can_cast(c.mana_cost, c.cmc):
                gs.cast_spell(c)
                break
