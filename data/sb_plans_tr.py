...
# Format: {(our_deck, opponent): (sb_in_list, sb_out_list)}
# Parsed from E:\vscode ai project\My-Website\modern\*.html

SB_PLANS = {
    ("Boros Energy", "Amulet Titan"): (['1 Blood Moon', '1 Meltdown', '2 Obsidian Charmaw'], []),
    ("Boros Energy", "Boros Energy Mirror"): (['2 Celestial Purge', '1 Blood Moon', '2 Wear // Tear'], []),
    ("Boros Energy", "Domain Zoo"): (['1 Surgical Extraction', '2 Celestial Purge'], []),
    ("Boros Energy", "Eldrazi Tron"): (['2 Wear // Tear', '1 Meltdown'], []),
    ("Boros Energy", "Esper Reanimator"): (['2 Celestial Purge', '1 Surgical Extraction'], []),
    ("Boros Energy", "Grixis Reanimator"): (['1 Surgical Extraction', '2 Celestial Purge'], []),
    ("Boros Energy", "Izzet Affinity"): (['2 Meltdown', '2 Wear // Tear'], []),
    ("Boros Energy", "Izzet Prowess"): (['1 High Noon', "1 Orim's Chant", '1 Wrath of the Skies', '2 Celestial Purge'], []),
    ("Boros Energy", "Ruby Storm"): (['1 High Noon', "1 Orim's Chant", '2 Celestial Purge'], []),
    ("Boros Energy", "UW / Jeskai Blink"): (['1 Wrath of the Skies', '2 Celestial Purge'], []),
    ("Boros Energy", "UW Control"): (['2 Wear // Tear', '2 The Legend of Roku'], []),
    ("Glockulous", "Amulet Titan"): (['2 Harbinger of the Seas', '2 Surgical Extraction', '1 Blood Moon'], ['2 Thought Scour', '1 Unearth']),
    ...
    ("Glockulous", "Domain Zoo"): (['3 Harbinger of the Seas', '2 Pyroclasm'], []),
    ("Glockulous", "Eldrazi Tron"): (['2 Nihil Spellbomb', '2 Harvester of Misery'], []),
    ("Glockulous", "Esper Reanimator"): (['2 Nihil Spellbomb', '2 Surgical Extraction'], []),
    ...
    ("Glockulous", "Izzet Affinity"): (['2 Harvester of Misery', '2 Pyroclasm'], []),
    ...
    ("Glockulous", "Ruby Storm"): (['2 Nihil Spellbomb', '2 Harvester of Misery'], []),
    ("Izzet Affinity", "Amulet Titan"): (['2 Consign to Memory', '1 Damping Sphere'], []),
    ("Izzet Affinity", "Azorius Control"): (['2 Mystical Dispute', '1 Force of Negation', '2 Blood Moon'], []),
    ("Izzet Affinity", "Boros Energy"): (['2 Whipflare'], []),
    ("Izzet Affinity", "Domain Aggro"): (['2 Whipflare', '2 Galvanic Blast'], []),
    ("Izzet Affinity", "Eldrazi Tron"): (['3 Blood Moon', '2 Damping Sphere'], []),
    ("Izzet Affinity", "Esper Reanimator"): (["1 Grafdigger's Cage", '2 Consign to Memory'], []),
    ("Izzet Affinity", "Grixis Reanimator"): (['2 Galvanic Blast', "1 Grafdigger's Cage"], []),
    ("Izzet Affinity", "Izzet Affinity Mirror"): (['2 Galvanic Blast', '2 Mystical Dispute'], []),
    ("Izzet Affinity", "Izzet Prowess"): (['2 Galvanic Blast', '2 Whipflare'], []),
    ("Izzet Affinity", "Jeskai Blink"): (['3 Blood Moon', '2 Mystical Dispute'], []),
    ("Izzet Affinity", "Ruby Storm"): (['3 Damping Sphere', '1 Force of Negation', '2 Consign to Memory'], []),
    ...
    ("Izzet Prowess", "Domain Zoo"): (['2 Dress Down', '1 Surgical Extraction'], []),
    ("Izzet Prowess", "Eldrazi Tron"): (['2 Surgical Extraction', '2 Blood Moon'], []),
    ("Izzet Prowess", "Esper Reanimator"): (['2 Surgical Extraction'], []),
    ("Izzet Prowess", "Grixis Reanimator"): (['1 Surgical Extraction', '2 Blood Moon'], ['2 Preordain', '1 Violent Urge']),
    ("Izzet Prowess", "Izzet Affinity"): (['2 Blood Moon'], []),
    ...
    ("Izzet Prowess", "Ruby Storm"): (['2 Blood Moon'], []),
    ...
    ("Jeskai Blink", "Domain Zoo"): (['2 Consign to Memory', '1 Stony Silence'], []),
    ("Jeskai Blink", "Eldrazi Tron"): (['2 Consign to Memory', '1 Pithing Needle'], []),
    ("Jeskai Blink", "Esper Reanimator"): (['2 Rest in Peace', '2 Consign to Memory'], []),
    ...
    ("Jeskai Blink", "Izzet Affinity"): (['2 Stony Silence', '2 Consign to Memory'], []),
    ...
    ("Jeskai Blink", "Ruby Storm"): (['3 Consign to Memory', '1 Rest in Peace'], []),
    ...
    ("UW Control", "Domain Zoo"): (['2 Wrath of the Skies (SB)', '2 Wrath of the Skies'], []),
    ("UW Control", "Eldrazi Tron"): (['3 Consign to Memory'], []),
    ("UW Control", "Esper Reanimator"): (['2 Rest in Peace', '3 Consign to Memory'], []),
    ("UW Control", "Glockulous"): (['2 Rest in Peace', '3 Consign to Memory'], ['2 Supreme Verdict', '2 Spell Snare', '1 Wrath of the Skies (main)']),
    ("UW Control", "Izzet Affinity"): (['3 Consign to Memory', '2 Wrath of the Skies (SB x2)'], []),
    ...
    ("UW Control", "Ruby Storm"): (['2 Consign to Memory', '2 Consign to Memory', '1 Tamiyo, Inquisitive Student'], []),
