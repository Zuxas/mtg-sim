...
class GameState:
    ...
    _WARP_CARDS = {
        ...
        # Removed 2026-06-29: Close Encounter / Gravitic Herald / Warped Tusker
        # were NOT Warp-keyword cards (verified against scryfall_oracle_cards.json
        # -- none has a "Warp {cost}" line; they were erroneous auto-generated
        # entries). They were latent no-ops (no APL/driver warp-casts them), so
        # removal is byte-identical in practice. Only braced, verified Warp-
        # keyword cards remain in this map.
